...
const EditUserProfile= () => {
    ...
    useEffect(()=>{
        ...
        try{
            axios.defaults.withCredentials=true;
            const res = await axios.get("http://ec2-3-35-152-30.ap-northeast-2.compute.amazonaws.com:8080/user/info");
    ...
    const reSave = () => {
        async function fetchReSavePage(){
            try{
              axios.defaults.withCredentials=true;
              const res = await axios.post("http://ec2-3-35-152-30.ap-northeast-2.compute.amazonaws.com:8080/user/edit",
              {
                id : 1,
                nickname : nickname,
                height : height,
