  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        const res = await axios.get("http://ec2-3-35-152-30.ap-northeast-2.compute.amazonaws.com:8080/coordinator/nickname");
  ...
  const handlePostUpload = () => {
    ...
    promise.then((data)=>{
      async function fetchData() {
        try {
          axios.defaults.withCredentials=true;
          const res = await axios.post('http://ec2-3-35-152-30.ap-northeast-2.compute.amazonaws.com:8080/board/create', 
            {
